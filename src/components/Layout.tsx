    ...
    <div className="container d-flex flex-column vh-100">
      <header className="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
        <Link to="/" className="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
          <span className="fs-4">Apartment rent</span>
        </Link>
      ...
      <footer className="d-flex flex-wrap justify-content-between align-items-center py-3 border-top mt-auto">
        <h5 className="col-md-4 mb-0 text-muted">© {new Date().getFullYear()} Apartment rent</h5>
        <ul className="nav col-md-4 justify-content-end">
          <li className="nav-item"><Link to="/" className="nav-link px-2 text-muted">Home</Link></li>
          <li className="nav-item"><Link to="/users" className="nav-link px-2 text-muted">Users</Link></li>
          <li className="nav-item"><Link to="/deals" className="nav-link px-2 text-muted">Deals</Link></li>
